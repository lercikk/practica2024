...
<div class="container mt-5">
    <div class="text-center mb-4">
        <img src="{{ asset('assets/images/visa.png') }}" alt="Career Counselling">
    </div>
    <h1 class="display-4 text-center mb-5">Visa Consultancy</h1>
    <div class="row mb-5">
    <div class="row mb-4">
                    <div class="col-12">
        ...
        <div class="col-md-6">
            ...
            <img src="{{ asset('assets/images/img4.png') }}" alt="Discover Your Path">
        </div>
        <div class="col-md-6">
    ...
    <div class="row mb-5">
        ...
        <div class="col-md-6">
            ...
            <img src="{{ asset('assets/images/img4.png') }}" alt="Virtual Career Fairs" >
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-6">
            ...
            <img src="{{ asset('assets/images/img4.png') }}" alt="Success Stories" >
        </div>
        <div class="col-md-6">
