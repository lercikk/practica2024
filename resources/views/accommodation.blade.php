...
<div class="container mt-5">
    <div class="text-center mb-4">
        <img src="{{ asset('assets/images/accommodation.png') }}" alt="Career Counselling">
    </div>
    <h1 class="display-4 text-center mb-5">Accommodation</h1>
    <div class="row mb-5">
    <div class="row mb-4">
                    <div class="col-12">
        ...
        <div class="col-md-6">
            ...
            <img src="{{ asset('assets/images/img7.png') }}" alt="Discover Your Path" >
        </div>
        <div class="col-md-6">
            <h4>Personalized Guidance</h4>
            <p>At Executive Study Abroad, our career counselling services are designed to help you uncover your true potential and align your academic pursuits with your career aspirations. Whether you're a high school student exploring your options or a university graduate looking to pivot into a new field, our experienced counsellors are here to guide you every step of the way.</p>
            <img src="{{ asset('assets/images/img7.png') }}" alt="Personalized Guidance" >
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-6">
            ...
            <img src="{{ asset('assets/images/img7.png') }}" alt="Interactive Workshops">
        </div>
        <div class="col-md-6">
            <h4>Virtual Career Fairs</h4>
            <p>At Executive Study Abroad, our career counselling services are designed to help you uncover your true potential and align your academic pursuits with your career aspirations. Whether you're a high school student exploring your options or a university graduate looking to pivot into a new field, our experienced counsellors are here to guide you every step of the way.</p>

            <img src="{{ asset('assets/images/img7.png') }}" alt="Virtual Career Fairs" >
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-6">
            ...
            <img src="{{ asset('assets/images/img7.png') }}" alt="Success Stories" >
        </div>
        <div class="col-md-6">
            <h4>Resources and Tools</h4>
            <p>At Executive Study Abroad, our career counselling services are designed to help you uncover your true potential and align your academic pursuits with your career aspirations. Whether you're a high school student exploring your options or a university graduate looking to pivot into a new field, our experienced counsellors are here to guide you every step of the way.</p>

            <img src="{{ asset('assets/images/img7.png') }}" alt="Resources and Tools" >
        </div>
    </div>
</div>
@endsection
